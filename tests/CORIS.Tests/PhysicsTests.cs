...
public class PhysicsTests
{
    ...
    public void VesselWithUpwardThrustAcceleratesUpward()
    {
        ...
        state.Orientation = new System.Numerics.Vector3(0f, 0f, 0f); // Set pitch to 0 (upward)
        ...
        var thrustDir = new System.Numerics.Vector3(0f, (float)System.Math.Cos(pitchRad), (float)System.Math.Sin(pitchRad));
        var thrustVec = thrustDir * (float)thrust;
        var netForce = thrustVec + new System.Numerics.Vector3(0f, (float)(-mass * gravity), 0f);
